...
/*
 * Returns 1 iff filename input is a file with a sudoku board in the correct format.
...
int checkHint_GuessHint_Commands(char* stream, int range, Status mode, int params[3]);
...
/*
 * Prints an appropriate error if excepted number of parameters is not equal to the amount of actual parameters,
