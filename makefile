CC = gcc
OBJS = main.o MainAux.o Game.o Solver.o Parser.o GameAux.o LinkedMovesList.o Stack.o ParserAux.o test.o Gurobi.o FileHandle.o StandardLinkedList.o
EXEC = sudoku
...
ParserAux.o: ParserAux.c Game.h MainAux.h Parser.h Solver.h LinkedMovesList.h ParserAux.h
	$(CC) $(COMP_FLAG) -c $*.c
test.o: test.c Game.h MainAux.h Parser.h Solver.h SPBufferset.h Stack.h GameAux.h ParserAux.h Gurobi.h FileHandle.h StandardLinkedList.h
	$(CC) $(COMP_FLAG) -c $*.c
FileHandle.o: FileHandle.c MainAux.h ParserAux.h GameAux.h Gurobi.h
	$(CC) $(COMP_FLAG) -c $*.c
StandardLinkedList.o: StandardLinkedList.c StandardLinkedList.h MainAux.h

$(EXEC): $(OBJS)
	$(CC) $(OBJS) $(GUROBI_LIB) -o $@ -lm
Gurobi.o: Gurobi.c Game.h Solver.h GameAux.h MainAux.h StandardLinkedList.h
